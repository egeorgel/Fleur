...
fleur::Twitter::type_listOfTweet fleur::Twitter::getTimeLineFromUserWithLimit() {
    assert(_twitter._crud == "get");
    if (!isLogIn()) {
        fleur::Twitter::type_listOfTweet listOfTweet;
...
fleur::Twitter::type_listOfTweet fleur::Twitter::searchForTwitContainStringWithLimit() {
...
fleur::Twitter::type_listOfTweet fleur::Twitter::getTwitSelfMentioningWithLimit() {
    assert(_twitter._crud == "get");
...
fleur::Twitter::type_tweet fleur::Twitter::postNewTweet() {
...
fleur::Twitter::type_tweet fleur::Twitter::deleteTweet() {
...
std::vector<std::string> fleur::Twitter::getCurrentTrendWithLimit() {
    assert(_twitter._crud == "get");
...
std::vector<std::string> fleur::Twitter::process() { //TODO: test in twitter_test.cpp
...
bool fleur::Twitter::isLogIn() {
    return _twitCurl.accountVerifyCredGet();
}

std::string fleur::Twitter::getWebResponse(bool isWorking) {
    std::string replyMsg;
    if (isWorking) {
...
fleur::Twitter::type_listOfTweet fleur::Twitter::json2TypeListOfTweetGetTimeLine(std::string json) {
    std::stringstream ss;
    ss << json;
...
fleur::Twitter::type_listOfTweet fleur::Twitter::json2TypeListOfTweetSearch(std::string json) {
    std::stringstream ss;
    ss << json;
    boost::property_tree::ptree pt;
    boost::property_tree::read_json(ss, pt);
...
fleur::Twitter::type_listOfTweet fleur::Twitter::json2TypeListOfTweetSelfMentioning(std::string json, int limit) {
    std::stringstream ss;
    ss << json;
    boost::property_tree::ptree pt;
    boost::property_tree::read_json(ss, pt);
...
fleur::Twitter::type_tweet fleur::Twitter::json2TypeTweetpostNewTweet(std::string json) {
    std::stringstream ss;
    ss << json;
    boost::property_tree::ptree pt;
    boost::property_tree::read_json(ss, pt);

    fleur::Twitter::type_tweet tweet;
    auto jsonP = nlohmann::json::parse(json);
    try {
...
fleur::Twitter::type_tweet fleur::Twitter::json2TypeTweetDeletTweet(std::string json) {
    std::stringstream ss;
    ss << json;
    boost::property_tree::ptree pt;
    boost::property_tree::read_json(ss, pt);
...
std::vector<std::string> fleur::Twitter::json2stringVecOfTrend(std::string json, int limit) {
    std::stringstream ss;
    ss << json;
    boost::property_tree::ptree pt;
    boost::property_tree::read_json(ss, pt);
...
fleur::Twitter::type_listOfTweet2VectorString(Twitter::type_listOfTweet listOfTweet, std::string keyName) {
...
std::vector<std::string> fleur::Twitter::type_tweet2VectorString(Twitter::type_tweet tweet, std::string typeOperation) {
