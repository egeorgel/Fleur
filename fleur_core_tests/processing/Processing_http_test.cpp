...
class Processing_http_test : public ::testing::Test {
protected:
...
TEST_F(Processing_http_test, selecet_html_from_url) {
    const std::string input = "select html from \"http://httpbin.org/html\";";
    fleur::parser::Requete requete;
    fleur::parser::doParse(input, requete);

    fleur::Processing_http processing(requete);
...
TEST_F(Processing_http_test, selecet_html__selectH1_from_url) {
...
TEST_F(Processing_http_test, selecet_html__select_p_a_from_url) {
...
TEST_F(Processing_http_test, selecet_html_select_h1_Class_a_from_url) {
...
TEST_F(Processing_http_test, selecet_json_from_url) {
